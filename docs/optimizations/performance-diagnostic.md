...
状态：**真实 Linux 诊断 PASS，2026-09-13 完整证据已核验**。[归档结果](../benchmarks/profile-validation.md)：10 万次请求零错误，约 5146 次/秒，客户端约占单核 62.88%，整机空闲约 4.97%。下一步为[客户端头部读取四轮对照](client-overhead.md)。下文保留本轮工具的执行方法与统计边界。
