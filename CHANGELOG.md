...
- 客户端、协议边界、诊断及汇总辅助测试 **16/16 PASS**，包括四轮执行及失败停止检查；真实 Linux 对照 **UNRUN**。本次只优化客户端代码，尚无 CPU 或吞吐收益结论；见[实验说明](docs/optimizations/client-overhead.md)。
